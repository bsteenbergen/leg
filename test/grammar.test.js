...
//  ["multiple statements", 'mumble("hey")\nbreak\nreturn'],
  ["variable declarations, strings", 'str s = "silly"'],
  ["variable declarations, integers", 'int x = 2'],
  //["type declarations", "int n = 2"],
 // ["function example", "task square(int toSquare) yields int^2"],
  //[
 ...
 // ["for half-open range", "int i = 1\nloop until i > 10:\ni = i + 1\nend"],
 // ["for closed range", "int i = 1\nloop until i > 10:\ni = i + 1\nend"],
...
//  ["malformed number", "int x = 2.", /Line 1, col 11:/],
 ...
 // ["if as identifier", "int if = 2", /Line 1, col 8/],
